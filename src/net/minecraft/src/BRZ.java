...
extends CAZ {
    ...
    public BRZ(Qnq qnq, double d, double d2, double d3, double d4, double d5, double d6) {
    ...
    public void method_7a46289a_Dne() {
        ...
        this.field_291868_XHL *= (double)0.86f;
        this.field_2a9ad1_Zpi *= (double)0.86f;
        this.field_31b811_kGO *= (double)0.86f;
    ...
    public BRZ(Qnq qnq, double d, double d2, double d3, double d4, double d5, double d6, float f) {
