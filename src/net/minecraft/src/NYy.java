...
extends CAZ {
    ...
    public void method_7a46289a_Dne() {
        ...
        this.field_22c5fd_IjH = this.field_1ed012_ATE + this.field_2a9ad1_Zpi * (double)f - (double)(f2 * 1.2f);
    ...
    public NYy(Qnq qnq, double d, double d2, double d3, double d4, double d5, double d6) {
        ...
        this.field_2092ab_Dne = this.field_267cf2_Qnq = this.field_7331eae7_Dne.nextFloat() * 0.5f + 0.2f;
        this.field_20b854_DyG = this.field_2f0dd5_div = 1.0f * f;
        this.field_388da3_zGp = this.field_2f0dd5_div;
        this.field_20b854_DyG *= 0.9f;
        this.field_388da3_zGp *= 0.9f;
        this.field_267cf5_Qnq = (int)(Math.random() * 10.0) + 30;
        this.field_31b827_kGO = true;
        this.method_143f9e1c_bzF((int)(Math.random() * 26.0 + 1.0 + 224.0));
    }
