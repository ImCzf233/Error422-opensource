...
extends xYY {
    ...
    protected void method_c619c53f_Dne(int n, int n2, WAR wAR) {
        ...
        if (this.field_2092ae_Dne == 0) {
            ZyA.method_750c5d25_Dne(this.field_37089ea_Dne, n + 115 - 18 + 1, n2 + 1 + 1, 72, 18);
        } else {
            ZyA.method_750c5d25_Dne(this.field_37089ea_Dne, n + 115 - 18, n2 + 1, 72, 18);
        }
        if (this.field_2092ae_Dne == 1) {
            ZyA.method_750c5d25_Dne(this.field_37089ea_Dne, n + 165 - 18 + 1, n2 + 1 + 1, 18, 18);
        } else {
            ZyA.method_750c5d25_Dne(this.field_37089ea_Dne, n + 165 - 18, n2 + 1, 18, 18);
        }
        if (this.field_2092ae_Dne == 2) {
            ZyA.method_750c5d25_Dne(this.field_37089ea_Dne, n + 215 - 18 + 1, n2 + 1 + 1, 36, 18);
        } else {
            ZyA.method_750c5d25_Dne(this.field_37089ea_Dne, n + 215 - 18, n2 + 1, 36, 18);
        }
    }
    ...
    protected void method_8a73475f_Dne(int n, int n2, int n3, int n4, WAR wAR) {
        ...
        this.method_31b5f37c_Dne((isy)trP.field_85a6f5b7_Qnq[n5], n2 + 115, n3, n % 2 == 0);
        this.method_31b5f37c_Dne((isy)trP.field_fde23b9f_FWm[n5], n2 + 165, n3, n % 2 == 0);
    ...
    public LAz(ZyA zyA) {
        ...
        for (isy isy2 : trP.field_7eb83e1f_bzF) {
            boolean bl = false;
            int n = isy2.method_7a46288d_Dne();
            if (ZyA.method_3e9ab6eb_Dne(zyA).method_831230f1_Dne(isy2) > 0) {
                bl = true;
            } else if (trP.field_85a6f5b7_Qnq[n] != null && ZyA.method_3e9ab6eb_Dne(zyA).method_831230f1_Dne(trP.field_85a6f5b7_Qnq[n]) > 0) {
                bl = true;
        ...
        this.field_740a65b4_Dne = new CfM(this, zyA);
    }
}
