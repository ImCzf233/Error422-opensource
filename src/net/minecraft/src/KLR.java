...
extends Suj {
                    ...
                    for (n8 = n9; !bl3 && n8 < n10; ++n8) {
                        for (int i = n13; !bl3 && i < n14; ++i) {
                            for (int j = n12 + 1; !bl3 && j >= n11 - 1; --j) {
                                ...
                                if (byArray[n7] == zKP.field_374330f_Dne.field_21260d_FWm || byArray[n7] == zKP.field_16319416_DyG.field_21260d_FWm) {
                                    bl3 = true;
                                }
                                ...
                                for (int i = n12 - 1; i >= n11; --i) {
                                    ...
                                    if (d15 > -0.7 && d13 * d13 + d15 * d15 + d14 * d14 < 1.0) {
                                        ...
                                        if (by == zKP.field_37e6aed_Dne.field_21260d_FWm || by == zKP.field_203836cc_FWm.field_21260d_FWm || by == zKP.field_36ff555_Dne.field_21260d_FWm) {
                                            if (i < 10) {
                                                byArray[n15] = (byte)zKP.field_202dfeee_FWm.field_21260d_FWm;
                                            } else {
                                                byArray[n15] = 0;
                                                if (bl4 && byArray[n15 - 1] == zKP.field_203836cc_FWm.field_21260d_FWm) {
                                                    byArray[n15 - 1] = this.field_36c4f18_Dne.method_90477c37_Dne((int)(n8 + n * 16), (int)(n7 + n2 * 16)).field_2092a7_Dne;
                                                }
                                            }
                                        }
                                    }
    ...
    protected void method_8632d3da_Dne(Qnq qnq, int n, int n2, int n3, int n4, byte[] byArray) {
        int n5 = this.field_7331eae7_Dne.nextInt(this.field_7331eae7_Dne.nextInt(this.field_7331eae7_Dne.nextInt(40) + 1) + 1);
        if (this.field_7331eae7_Dne.nextInt(15) != 0) {
            n5 = 0;
        }
        for (int i = 0; i < n5; ++i) {
            double d = n * 16 + this.field_7331eae7_Dne.nextInt(16);
            double d2 = this.field_7331eae7_Dne.nextInt(this.field_7331eae7_Dne.nextInt(120) + 8);
            ...
            for (int j = 0; j < n6; ++j) {
                ...
                if (this.field_7331eae7_Dne.nextInt(10) == 0) {
                    f3 *= this.field_7331eae7_Dne.nextFloat() * this.field_7331eae7_Dne.nextFloat() * 3.0f + 1.0f;
                }
                this.method_3b3557ab_Dne(this.field_7331eae7_Dne.nextLong(), n3, n4, byArray, d, d2, d3, f3, f, f2, 0, 0, 1.0);
            }
        }
    }
