...
extends CAZ {
    ...
    public RlB(Qnq qnq, double d, double d2, double d3, double d4, double d5, double d6) {
        this(qnq, d, d2, d3, d4, d5, d6, 2.0f);
    }
    ...
    public void method_7a46289a_Dne() {
        ...
        this.field_291868_XHL *= (double)0.66f;
        this.field_2a9ad1_Zpi *= (double)0.66f;
        this.field_31b811_kGO *= (double)0.66f;
    ...
    public RlB(Qnq qnq, double d, double d2, double d3, double d4, double d5, double d6, float f) {
        super(qnq, d, d2, d3, 0.0, 0.0, 0.0);
        this.field_291868_XHL *= (double)0.01f;
        this.field_2a9ad1_Zpi *= (double)0.01f;
        this.field_31b811_kGO *= (double)0.01f;
        this.field_2a9ad1_Zpi += 0.2;
        this.field_388da3_zGp = geR.method_ce7f5256_Dne(((float)d4 + 0.0f) * (float)Math.PI * 2.0f) * 0.65f + 0.35f;
        this.field_20b854_DyG = geR.method_ce7f5256_Dne(((float)d4 + 0.33333334f) * (float)Math.PI * 2.0f) * 0.65f + 0.35f;
        this.field_2f0dd5_div = geR.method_ce7f5256_Dne(((float)d4 + 0.6666667f) * (float)Math.PI * 2.0f) * 0.65f + 0.35f;
        this.field_267cf2_Qnq *= 0.75f;
        this.field_267cf2_Qnq *= f;
        this.field_2092ab_Dne = this.field_267cf2_Qnq;
        this.field_267cf5_Qnq = 6;
        this.field_31b827_kGO = false;
        this.method_143f9e1c_bzF(64);
    }
}
