...
extends gwq {
        ...
        for (int i = n - n4; i <= n + n4; ++i) {
            for (int j = n3 - n4; j <= n3 + n4; ++j) {
                ...
                for (int k = n2 - n5; k <= n2 + n5; ++k) {
                    ...
                    if (n8 != zKP.field_203836cc_FWm.field_21260d_FWm && n8 != zKP.field_90d58f6f_lMz.field_21260d_FWm) continue;
    ...
    public Kmf(int n) {
        this.field_2092ae_Dne = zKP.field_90d58f6f_lMz.field_21260d_FWm;
