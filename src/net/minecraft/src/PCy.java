...
extends ram {
    ...
    public PCy(opc opc2, int n, Random random, CLK cLK, int n2) {
        super(opc2, n);
    ...
    public boolean method_f28ef3a4_Dne(Qnq qnq, Random random, CLK cLK) {
        ...
        this.method_3d7d4888_Dne(qnq, cLK, 0, 1, 0, 6, 4, 8, 0, 0, false);
        ...
        this.method_3d7d4888_Dne(qnq, cLK, 1, 0, 0, 5, 0, 0, zKP.field_af0f1368_udO.field_21260d_FWm, zKP.field_af0f1368_udO.field_21260d_FWm, false);
        this.method_3d7d4888_Dne(qnq, cLK, 1, 0, 8, 5, 0, 8, zKP.field_af0f1368_udO.field_21260d_FWm, zKP.field_af0f1368_udO.field_21260d_FWm, false);
    ...
    public static PCy method_91f928ac_Dne(opc opc2, List list, Random random, int n, int n2, int n3, int n4, int n5) {
        CLK cLK = CLK.method_286c569_Dne(n, n2, n3, 0, 0, 0, 7, 4, 9, n4);
        return PCy.method_697d22a9_Dne(cLK) && bvz.method_9e83199f_Dne(list, cLK) == null ? new PCy(opc2, n5, random, cLK, n4) : null;
    }
}
