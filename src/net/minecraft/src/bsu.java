...
extends CAZ {
    ...
    public bsu(Qnq qnq, double d, double d2, double d3, double d4, double d5, double d6, float f) {
        ...
        this.field_20b854_DyG = this.field_2f0dd5_div = (float)(Math.random() * (double)0.3f);
    ...
    public bsu(Qnq qnq, double d, double d2, double d3, double d4, double d5, double d6) {
