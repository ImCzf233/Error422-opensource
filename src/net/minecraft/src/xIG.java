...
public class xIG
extends iDn {
    public xIG(int n, Random random, CLK cLK, int n2) {
        super(n);
    ...
    public static xIG method_58594947_Dne(List list, Random random, int n, int n2, int n3, int n4, int n5) {
        CLK cLK = CLK.method_286c569_Dne(n, n2, n3, -1, 0, 0, 5, 7, 5, n4);
        return xIG.method_697d22a9_Dne(cLK) && bvz.method_9e83199f_Dne(list, cLK) == null ? new xIG(n5, random, cLK, n4) : null;
    }
    ...
    public boolean method_f28ef3a4_Dne(Qnq qnq, Random random, CLK cLK) {
        ...
        this.method_3d7d4888_Dne(qnq, cLK, 1, 2, 4, 4, 5, 4, zKP.field_38c5f505_iNH.field_21260d_FWm, zKP.field_38c5f505_iNH.field_21260d_FWm, false);
