...
extends tip {
    ...
    public NMq method_a003e203_FWm(cwq_0 cwq_02, NMq nMq) {
        ...
        KFd kFd = qnq.method_d9802b31_Dne(n3, n2 = cwq_02.method_7c6f602c_FWm() + hQH.method_7c6f602c_FWm(), n = cwq_02.method_ae128dba_bzF() + hQH.method_ae128dba_bzF());
        if (KFd.field_1411d34d_div.equals(kFd)) {
            d = 1.0;
        } else {
            if (!KFd.field_368fd23_Dne.equals(kFd) || !KFd.field_1411d34d_div.equals(qnq.method_d9802b31_Dne(n3, n2 - 1, n))) {
                return this.field_37c2531_Dne.method_267feca4_Dne(cwq_02, nMq);
            }
            d = 0.0;
        }
        iMX iMX2 = new iMX(qnq, d2, d3 + d, d4);
        qnq.method_94d18be5_FWm(iMX2);
